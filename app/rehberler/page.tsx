      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
                Tüm yamalar, şampiyonlar ve makro oyun stratejileri tek bir yerde.
            </p>
        </div>
            ...
            <Link href="/rehberler/mid-lane" className="group block h-full">
                <div className="bg-[#0A1120] border border-white/5 rounded-2xl overflow-hidden hover:border-[#00FFFF] transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,255,255,0.2)] hover:-translate-y-2 h-full flex flex-col">
                    <div className="h-48 bg-gradient-to-br from-cyan-900/20 to-blue-900/20 relative p-6 flex flex-col justify-between border-b border-white/5 group-hover:from-cyan-900/40 transition-colors">
                        <div className="absolute top-4 right-4 bg-[#00FFFF] text-black text-[10px] font-black px-2 py-1 rounded shadow-lg shadow-cyan-500/20 uppercase tracking-wider">Master+</div>
                        <Brain className="w-12 h-12 text-[#00FFFF] opacity-50 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-[#00FFFF] font-brand tracking-widest opacity-80 italic">MID LANE</h3>
                    </div>
                    <div className="p-6 flex-1 flex flex-col">
                        <h2 className="text-xl font-bold text-white mb-3 group-hover:text-[#00FFFF]">Sezon 16: Orta Koridor</h2>
                        <p className="text-sm text-gray-400 mb-6 flex-1 italic">Profesyonel analizlere dayalı makro stratejiler.</p>
                        <span className="text-[#00FFFF] text-xs font-bold uppercase flex items-center gap-2">OKUMAYA BAŞLA <ArrowLeft className="w-3 h-3 rotate-180" /></span>
                    </div>
                </div>
            </Link>

            {/* 2. KART: TOP LANE (YAKINDA) */}
            <div className="group block h-full opacity-50">
                <div className="bg-[#0A1120] border border-white/5 rounded-2xl overflow-hidden grayscale h-full flex flex-col">
                    <div className="h-48 bg-gradient-to-br from-red-900/10 to-orange-900/10 relative p-6 flex flex-col justify-between border-b border-white/5">
                        <div className="absolute top-4 right-4 bg-gray-700 text-white text-[10px] font-black px-2 py-1 rounded uppercase tracking-wider">Yakında</div>
                    ...
                    <div className="p-6 flex-1">
                        ...
                        <p className="text-sm text-gray-600">Split push ve ada psikolojisi çok yakında.</p>
                    </div>
                </div>
            </div>
            ...
            <Link href="/rehberler/jungle" className="group block h-full">
                <div className="bg-[#0A1120] border border-white/5 rounded-2xl overflow-hidden hover:border-emerald-400 transition-all duration-300 hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] hover:-translate-y-2 h-full flex flex-col">
                    <div className="h-48 bg-gradient-to-br from-emerald-900/20 to-green-900/20 relative p-6 flex flex-col justify-between border-b border-white/5 group-hover:from-emerald-900/40 transition-colors">
                        <div className="absolute top-4 right-4 bg-emerald-400 text-black text-[10px] font-black px-2 py-1 rounded shadow-lg shadow-emerald-500/20 uppercase tracking-wider">Master+</div>
                        <Timer className="w-12 h-12 text-emerald-400 opacity-50 group-hover:scale-110 transition-transform" />
                        <h3 className="text-2xl font-bold text-emerald-400 font-brand tracking-widest opacity-80 italic">JUNGLE</h3>
                    </div>
                    <div className="p-6 flex-1 flex flex-col">
                        <h2 className="text-xl font-bold text-white mb-3 group-hover:text-emerald-400">Sezon 16: Orman Yolları</h2>
                        <p className="text-sm text-gray-400 mb-6 flex-1 italic">Yeni orman rotaları ve harita kontrolü taktikleri.</p>
                        <span className="text-emerald-400 text-xs font-bold uppercase flex items-center gap-2">OKUMAYA BAŞLA <ArrowLeft className="w-3 h-3 rotate-180" /></span>
                    </div>
                </div>
            </Link>
